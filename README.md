...
Juilliard and Peabody remain candidates. On September 25, 2026, direct checks of [Juilliard's calendar](https://www.juilliard.edu/calendar) and [Peabody's current calendar](https://peabody.jhu.edu/events/) returned HTTP 403. Juilliard's official information confirms that it offers livestreams, with some programs requiring a free Juilliard LIVE login. These schools are not absent for lack of streaming or artistic importance; reliable unattended retrieval has not been established. They are not filled with guessed or search-cached events.
