...
The test suite covers time zones, DST ambiguity, date filters, `.ics` escaping and UTF-8 folding, parser rules for all nine active schools and the deferred Liechtenstein prototype, pagination, and failed-source retention. European parser fixtures preserve small relevant excerpts of the official HTML observed on September 25, 2026.
