...
- Events are deduplicated, sorted, and filtered by date. Expired events disappear in the browser even between refreshes; the public calendar has no past-performance archive. Unknown end times use a clearly disclosed 90-minute estimate.
